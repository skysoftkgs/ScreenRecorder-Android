...
public class ComposerTranscodeCoreActivity extends ActivityWithTimeline implements SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // requestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        updateUI(false);
        LinearLayout transcodeParameterLayout = (LinearLayout)findViewById(R.id.transcodeParametersLayout);
        transcodeParameterLayout.setVisibility(View.GONE);
    }
    ...
    protected void initVideoSpinners() {
        ...
        frameSizeSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                videoWidthOut = Integer.valueOf(frameSizeContainer[1].trim());
                videoHeightOut = Integer.valueOf(frameSizeContainer[0].trim());
                Log.e("Cut video","WIDTH = "+videoWidthOut + "height = "+videoHeightOut + "In W = "+videoWidthIn + "In H "+ videoHeightIn);
            }
    ...
    protected void getFileInfo() {
        try {
            ...
            if (videoFormat == null) {
                ...
                //Transcode with the same
                videoWidthOut = videoWidthIn;
                videoHeightOut = videoHeightIn;
            }
        } catch (Exception e) {
            String message = (e.getMessage() != null) ? e.getMessage() : e.toString();
    ...
    protected void configureVideoEncoder(org.m4m.MediaComposer mediaComposer, int width, int height) {
        ...
        Log.e("ConfigureVideo","W H = "+width +":"+height);
