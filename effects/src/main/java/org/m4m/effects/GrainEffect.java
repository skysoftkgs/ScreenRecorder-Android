 ...
 */
public class GrainEffect extends VideoEffect {
    private int mWidth;
    private int mHeight;
     ...
     */
    public GrainEffect(int angle, IEglUtil eglUtil, float strength, int mWidth, int mHeight) {
        super(angle, eglUtil);
        if (strength < 0.0f)
            strength = 0.0f;
        if (strength > 1.0f)
        ...
        setFragmentShader(getShader(mWidth,mHeight));
    ...
    protected String getShader(int mWidth, int mHeight){
