 ...
 */
public class LamoishEffect extends VideoEffect {
    private int mWidth;
    private int mHeight;
    private Random mRandom;

    public LamoishEffect(int angle, IEglUtil eglUtil, int width, int height) {
        super(angle, eglUtil);
        setFragmentShader(getShader(width,height));
    }
    protected String getShader(int width, int mHeight){
        initValues(width,mHeight);
