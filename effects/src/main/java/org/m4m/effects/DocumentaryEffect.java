 ...
 */
public class DocumentaryEffect extends VideoEffect {
    private int mWidth;
    private int mHeight;
    private Random mRandom;

    public DocumentaryEffect(int angle, IEglUtil eglUtil,int mWidth, int mHeight) {
        super(angle, eglUtil);

        setFragmentShader(getFragmentShader(mWidth,mHeight));
    }
    protected  String getFragmentShader(int width, int height){
